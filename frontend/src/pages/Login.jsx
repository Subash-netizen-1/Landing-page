            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex justify-center w-full px-4 py-3 text-sm font-semibold text-white bg-brand-600 hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-500 rounded-xl transition-all shadow-md active:scale-98 disabled:opacity-50 gap-2 items-center"
                >
                  {submitting 
              ...
              <div className="mt-8 pt-6 border-t border-gray-150 dark:border-gray-850">
                ...
                <div className="grid grid-cols-1 gap-2">
                  <button
                    ...
                    className="flex justify-between items-center px-4 py-2.5 text-xs font-semibold text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 hover:bg-gray-55/60 dark:hover:bg-gray-850 border border-gray-200 dark:border-gray-800 rounded-xl transition-all"
                  >
            ...
            {import.meta.env.VITE_SUPABASE_URL && import.meta.env.VITE_SUPABASE_ANON_KEY && (
              <div className="mt-6 text-center">
                <button
                  ...
                  className="text-xs font-semibold text-gray-550 hover:text-brand-600 dark:text-gray-400 dark:hover:text-brand-400 underline decoration-dotted"
                >
